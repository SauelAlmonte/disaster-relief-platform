...
const AnimationSegment = React.memo(
  (props: {
    ...
    const { segment, variants, per, segmentWrapperClassName } = props;
    const content =
      per === "line" ? (
...
const instantTransition = { duration: 0, staggerChildren: 0, delayChildren: 0 };
...
export function TextEffect({
  ...
  const MotionTag = (motion[as as keyof typeof motion] ?? motion.p) as typeof motion.div;
